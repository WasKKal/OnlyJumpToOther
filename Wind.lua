...
Accent=Color3.fromHex"#161616",
Dialog=Color3.fromHex"#111111",
Outline=Color3.fromHex"#2a2a2a",
Text=Color3.fromHex"#ebebf0",
Placeholder=Color3.fromHex"#6e6e73",
Background=Color3.fromHex"#0a0a0a",
Button=Color3.fromHex"#2c2c2e",
Icon=Color3.fromHex"#a2a2a2",
Toggle=Color3.fromHex"#30d158",
Slider=Color3.fromHex"#a2a2a2",
Checkbox=Color3.fromHex"#a2a2a2",
},
Obsidian={
Name="Obsidian",

Accent=Color3.fromHex"#1c1c1e",
Dialog=Color3.fromHex"#161618",
Outline=Color3.fromHex"#3a3a3c",
...
local __cr=(typeof(aq.CornerRadius)=="number" and UDim.new(0,aq.CornerRadius) or aq.CornerRadius)
am.UICorner.CornerRadius=__cr
am.TextButton.UICorner.CornerRadius=UDim.new(__cr.Scale,math.max(0,__cr.Offset-4))
...
User=ar.User or{},
Footer=ar.Footer or{},
Topbar=ar.Topbar or{Height=48,ButtonsType="Default"},

Size=ar.Size,

MinSize=ar.MinSize or Vector2.new(480,360),
MaxSize=ar.MaxSize or Vector2.new(1000,700),

TopBarButtonIconSize=ar.TopBarButtonIconSize or 16,

ToggleKey=ar.ToggleKey or nil,
NoKeybind=ar.NoKeybind~=false,
ElementsRadius=ar.ElementsRadius,
Radius=ar.Radius or 20,
Transparent=ar.Transparent or false,
HideSearchBar=ar.HideSearchBar~=false,
ScrollBarEnabled=ar.ScrollBarEnabled or false,
SideBarWidth=ar.SideBarWidth or 220,
...
as.ElementConfig={
UIPadding=(as.NewElements and 10 or 12),
UICorner=as.ElementsRadius or(as.NewElements and 24 or 14),
}

local au=as.Size or UDim2.new(0,740,0,560)
as.Size=UDim2.new(
au.X.Scale,
...
-- 改造后：手机与电脑使用完全一致的交互逻辑
as.IsPC=true
as.UniformPlatform=true
...
as.SnowContainer=as.UIElements.Main.Background:WaitForChild"SnowContainer"
...
if as.NoKeybind then return end
